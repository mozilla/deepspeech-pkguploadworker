    ...
    if 'jcenter' in upload_targets:
        ...
        for mavenZip in allAarPackages:
            ...
            with open(mavenZip, 'r') as put_data:
                r = requests.put('https://api.bintray.com/content/{}/{}/{}/{}/{}'.format(bintray_username, bintray_repo, bintray_pkg, bintray_version, zipFile), params = { 'publish': 1, 'override': 1, 'explode': 1 }, data = put_data, headers = {'Content-Type': 'application/octet-stream' }, auth = (bintray_username, bintray_apikey))
